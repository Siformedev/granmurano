            ...
            <div class="dropdown dropdown-avatar">
                <a href="javascript: void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <span class="avatar" href="javascript:void(0);">
                        <img src="{{asset(auth()->user()->userable->img)}}" alt="IMG Perfil" class="img_crop_perfil">
                    </span>
                </a>
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="" role="menu">
                    ...
                    <div class="dropdown-header">Comissão</div>
                    <a class="dropdown-item" href="{{route('comissao.painel')}}"><span class="label label-success"><i class="dropdown-icon icmn-exit"></i> Acessar Painel</span></a>
                    @endif()
        ...
        <!--<div class="menu-info-block">
            ...
            <div class="menu-info-block">
                <div class="center-block text-center">
                    <img class="height-50 logo-mobile" src="{{ asset('assets/common/img/logo.png') }}" alt="{{env('APP_NAME')}} LOGO" style="width: 100px !important">
                </div>
            </div>
        </div>
    </div>
