                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select class="form-control" id="permiterenegociacao" name="permite_renegociacao" >
                                        <option>Permite renegociação ?</option>
                                        <option value="1">Sim</option>
                                        <option value="0">Não</option>
                                    </select>

                                </td>
                                <td><input class="form-control" type="text" placeholder="Multa" name="multa"></td>
                                <td><input class="form-control" type="text" placeholder="Juros Mensais" name="juros_ao_mes"></td>
